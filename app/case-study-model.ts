...
export const caseStudyProfiles: readonly CaseStudyProfile[] = seeds.map(
  (seed, projectIndex) => ({
    ...
    apps: [...new Set([...seed.mountedAppIds, "statistics" as const, "simulation" as const])],
...
export const caseStudyProjects: readonly WorkspaceProject[] = seeds.map(
  (seed) => ({
    ...
    counts: { ...seed.counts, apps: new Set([...seed.mountedAppIds, "statistics" as const, "simulation" as const]).size },
    metrics: seed.metrics,
    mountedAppIds: [...new Set([...seed.mountedAppIds, "statistics" as const, "simulation" as const])],
