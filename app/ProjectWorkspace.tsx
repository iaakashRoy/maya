...
function GovernancePanel({ project, onOutcome, onEvidence }: { project: WorkspaceProject; onOutcome: OutcomeHandler; onEvidence: (target: string | EvidenceReceipt) => void }) {
  const controls = [
    ...
    { id: "human-gate", icon: "◎", tone: "approval", name: "Human release approval", detail: "Require a named client or Kearney decision right before release.", defaultOn: true, critical: true },
