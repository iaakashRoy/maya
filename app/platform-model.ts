...
export const decisionCases: readonly DecisionCase[] = [
  {
    id: "CASE-1042", scope: "company", title: "Secure alternate graphite volume", summary: "Protect four priority mobility programs from tightening merchant graphite capacity without violating qualification, cash, or carbon limits.", severity: "Critical", status: "Awaiting approval", stage: "Approve", owner: "Asha Rao", ownerInitials: "AR", due: "2h remaining", updated: "8 min ago", value: "$4.2M margin exposed", serviceExposure: "428 priority orders", confidence: 92, primaryEntity: "Graphite G-142",
