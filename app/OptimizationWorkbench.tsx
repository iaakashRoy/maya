  ...
  return (
    <div className="app-workspace optimizer-workbench">
      <section className="optimizer-hero">
        <div className="optimizer-hero-code">NO</div><div><p className="kicker">{snapshot.shortLabel.toUpperCase()} · {activeCase.id} · PROJECT APP</p><h1 tabIndex={-1} data-page-heading>Network Optimizer</h1><p>Define the decision model, compare scenarios, and prepare a response for expert review.</p></div>
