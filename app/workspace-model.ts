...
export const projectApps: readonly ProjectAppDefinition[] = [
  ...
  { id: "flow", name: "FlowLens", icon: "FL", accent: "#6ed0ff", archetype: "Material-to-cash Sankey", outcome: "Release cash without harming service", artifact: "Cash action package", methodCodes: ["M-05", "M-06", "M-24"], variableIds: ["L0-155", "L0-290", "L0-312"], status: "Concept ready" },
  { id: "demand", name: "DemandSense", icon: "DS", accent: "#b8a4ff", archetype: "Forecast fan + causal notebook", outcome: "Commit an explainable demand range", artifact: "Demand contract", methodCodes: ["M-02", "M-03", "M-04", "M-20"], variableIds: ["L0-001", "L0-016", "L2-011"], status: "Concept ready" },
  { id: "suppliers", name: "SupplierGraph", icon: "SG", accent: "#77d59c", archetype: "N-tier graph + qualification funnel", outcome: "Find dependency and optionality", artifact: "Qualified shortlist", methodCodes: ["M-22", "M-25", "M-29"], variableIds: ["L0-057", "L0-044", "L0-056"], status: "Concept ready" },
  { id: "minerals", name: "MineralAtlas", icon: "MA", accent: "#d89b5b", archetype: "Reserve-to-refinery atlas", outcome: "Trace critical minerals country to product", artifact: "Mineral sourcing scenario", methodCodes: ["M-05", "M-16", "M-20", "M-22", "M-23", "M-24"], variableIds: ["L0-030", "L0-035", "L0-371", "L0-394", "L0-410"], status: "Concept ready" },
  { id: "workforce", name: "WorkforceStudio", icon: "WS", accent: "#8f9cff", archetype: "Skill matrix + shift builder", outcome: "Cover capacity with qualified people", artifact: "Workforce capacity plan", methodCodes: ["M-08", "M-14", "M-17", "M-21", "M-24"], variableIds: ["L0-101", "L0-102", "L0-105", "L0-110"], status: "Concept ready" },
  { id: "manufacturing", name: "ManufacturingTwin", icon: "MT", accent: "#7da2b8", archetype: "Plant flow + constraint Gantt", outcome: "Schedule the constraint, not averages", artifact: "Production plan", methodCodes: ["M-06", "M-07", "M-08", "M-15", "M-17", "M-27"], variableIds: ["L0-071", "L0-074", "L0-079", "L0-088", "L0-097"], status: "Concept ready" },
  { id: "logistics", name: "LogisticsRadar", icon: "LR", accent: "#4ee2df", archetype: "Map radar + transfer playback", outcome: "Control every cargo handoff", artifact: "Route and handoff plan", methodCodes: ["M-05", "M-09", "M-10", "M-11", "M-12", "M-17"], variableIds: ["L0-202", "L0-209", "L0-217", "L0-229", "L0-241"], status: "Concept ready" },
  { id: "quality", name: "QualityGenealogy", icon: "QG", accent: "#ffcf70", archetype: "Batch genealogy + release gates", outcome: "Trace every quality consequence", artifact: "Release or containment plan", methodCodes: ["M-15", "M-21", "M-26", "M-30"], variableIds: ["L0-131", "L0-141", "L0-145", "L0-151"], status: "Concept ready" },
];
